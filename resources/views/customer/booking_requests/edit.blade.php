...
@section('content')
<div class="container">
    <form action="{{ route('customer.booking_requests.update', $bookingRequest->id) }}" method="POST">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" 
                    value="{{ $bookingRequest->court->name }} (₱{{ $bookingRequest->court->hourly_rate }}/hour)" readonly>
                <input type="hidden" name="court_id" value="{{ $bookingRequest->court_id }}">
            </div>
            <div class="row">
                <div class="col-md-4">
                        <!-- Date -->
                        <div class="mb-3">
                            ...
                            <input type="date" name="booking_date" id="booking_date" class="form-control" 
                                value="{{ \Carbon\Carbon::parse($bookingRequest->start_time)->toDateString() }}" required>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" name="start_time" id="start_time" class="form-control" 
                            value="{{ \Carbon\Carbon::parse($bookingRequest->start_time)->format('H:i') }}" required>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" name="end_time" id="end_time" class="form-control" 
                            value="{{ \Carbon\Carbon::parse($bookingRequest->end_time)->format('H:i') }}" readonly required>
                    </div>
            ...
            <input type="hidden" id="expected_hours" value="{{ $bookingRequest->expected_hours }}">
            <input type="hidden" id="expected_minutes" value="{{ $bookingRequest->expected_minutes }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="transaction_no" class="form-control" 
                    value="{{ $bookingRequest->transaction_no }}" required>
            </div>
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('customer.booking_requests.index') }}" class="btn btn-secondary btn-sm">Back</a>
        </div>
