...
<div class="container-fluid">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ Str::limit($court->description, 50) }}</td>
            <td>
                @if($court->images && is_array($court->images))
                    <div class="d-flex flex-wrap">
                        @foreach($court->images as $img)
                            <img src="{{ asset('storage/'.$img) }}" alt="Court Image" 
                                 style="width:60px; height:60px; object-fit:cover; margin:2px; border-radius:5px;">
                        @endforeach
                    </div>
                @else
            ...
            <td class="text-center" style="white-space: nowrap;">
                <a href="{{ route('admin.courts.edit', $court) }}" class="btn btn-sm btn-warning">Edit</a>
